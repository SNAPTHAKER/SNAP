...
DevId = Config.DevId
SudoIds = {Config.SudoIds,158798879,1783964439}
SNAP = Config.SNAP
...
if text == "مطوࢪ السوࢪس" or text == "مطور السورس" or text == "المبرمج" then 
